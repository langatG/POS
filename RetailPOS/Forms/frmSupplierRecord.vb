        ...
        Try
            If dgw.Rows.Count > 0 Then
                ...
                If lblSet.Text = "Supplier Entry" Then
                    ...
                    frmSupplier.txtAddressLine1.Text = dr.Cells(3).Value.ToString()
                    frmSupplier.txtAddressLine2.Text = dr.Cells(4).Value.ToString()
                    frmSupplier.txtAddressLine3.Text = dr.Cells(5).Value.ToString()
                ...
                If lblSet.Text = "Purchase" Then
                    ...
                    frmPurchaseEntry.txtAddressLine1.Text = dr.Cells(3).Value.ToString()
                    frmPurchaseEntry.txtAddressLine2.Text = dr.Cells(4).Value.ToString()
