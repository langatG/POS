...
Public Class frmPayment
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            Timer1.Enabled = True
            Dim rpt As New rptPaymentInvoice 'The report you created.
            ...
            MyCommand.CommandText = "SELECT Payment.T_ID, Payment.TransactionID, Payment.Date, Payment.PaymentMode, Payment.SupplierID, Payment.Amount, Payment.Remarks, Payment.PaymentModeDetails, Supplier.ID, Supplier.SupplierID AS Expr1,Supplier.Name, Supplier.Address, Supplier.City, Supplier.State, Supplier.ZipCode, Supplier.ContactNo, Supplier.EmailID, Supplier.Remarks AS Expr2, Supplier.TIN, Supplier.STNo, Supplier.CST, Supplier.PAN,Supplier.AccountName, Supplier.AccountNumber, Supplier.Bank, Supplier.Branch, Supplier.IFSCCode, Supplier.OpeningBalance, Supplier.OpeningBalanceType FROM Payment INNER JOIN Supplier ON Payment.SupplierID = Supplier.ID where T_ID=" & Val(txtT_ID.Text) & ""
            MyCommand1.CommandText = "SELECT * from Company"
            MyCommand.CommandType = CommandType.Text
            MyCommand1.CommandType = CommandType.Text
            myDA.SelectCommand = MyCommand
            myDA1.SelectCommand = MyCommand1
            myDA.Fill(myDS, "Payment")
