Public Class frmGetCash
    ...
    Private Sub btnOkay_Click(sender As System.Object, e As System.EventArgs) Handles btnOkay.Click
        Try
            If txtCash.Text = "" Then
                ...
                Exit Sub
            End If
            frmPOS.txtCash.Text = txtCash.Text
            Me.Close()
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If sign_Indicator = 0 Then
            txtCash.Text = txtCash.Text + Convert.ToString(10)
        ElseIf sign_Indicator = 1 Then
            txtCash.Text = Convert.ToString(50)
            sign_Indicator = 0
        End If
        fl = True
    End Sub
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        If sign_Indicator = 0 Then
            txtCash.Text = txtCash.Text + Convert.ToString(50)
        ElseIf sign_Indicator = 1 Then
            txtCash.Text = Convert.ToString(100)
            sign_Indicator = 0
        End If
        fl = True
    End Sub
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        If sign_Indicator = 0 Then
            txtCash.Text = txtCash.Text + Convert.ToString(100)
        ElseIf sign_Indicator = 1 Then
            txtCash.Text = Convert.ToString(500)
            sign_Indicator = 0
        End If
        fl = True
    End Sub
    ...
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        If sign_Indicator = 0 Then
            txtCash.Text = txtCash.Text + Convert.ToString(500)
        ElseIf sign_Indicator = 1 Then
            txtCash.Text = Convert.ToString(2000)
            sign_Indicator = 0
        End If
        fl = True
    End Sub
