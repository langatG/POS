    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If txtActivationID.Text = TextBox1.Text Then
                ...
                Me.Hide()
            Else
                MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact us at :" & vbCrLf & "Vaibhav Patidar" & vbCrLf & "Email-Vaibhavpatidar36@gmail.com" & vbCrLf & "Mobile No. +919630014949", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        Catch ex As Exception
