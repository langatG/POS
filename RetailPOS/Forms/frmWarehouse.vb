...
Public Class frmWarehouse
    ...
    Private Sub DeleteRecord()
        ...
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cl As String = "select WarehouseName from Product_OpeningStock,Warehouse where Product_OpeningStock.Warehouse_Store=Warehouse.WarehouseName and WarehouseName=@d1"
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cl4 As String = "select WarehouseName from StockTransfer_W2W,Warehouse where StockTransfer_W2W.Warehouse=Warehouse.WarehouseName and WarehouseName=@d1"
            cmd = New SqlCommand(cl4)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", txtWarehouseName.Text)
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
                MessageBox.Show("Unable to delete..Already in use in Stock Transfer(W2W)", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                If Not rdr Is Nothing Then
                    rdr.Close()
                End If
                Exit Sub
            ...
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
                MessageBox.Show("Unable to delete..Already in use in Stock Transfer(W2S)", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                If Not rdr Is Nothing Then
                    rdr.Close()
                End If
                Exit Sub
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cl1 As String = "select WarehouseName from Purchase_Join,Warehouse where Purchase_Join.Warehouse_Store=Warehouse.WarehouseName and WarehouseName=@d1"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            cmd.Parameters.AddWithValue("@d1", txtWarehouseName.Text)
            cmd.Parameters.AddWithValue("@d2", txtWarehouse.Text)
            cmd.Connection = con
            cmd.ExecuteNonQuery()
            con.Close()
            con = New SqlConnection(cs)
            con.Open()
            Dim cb2 As String = "update StockTransfer_Join_W2W set Warehouse=@d1 where Warehouse=@d2"
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cb3 As String = "update Purchase_Join set Warehouse_Store=@d1 where Warehouse_Store=@d2"
