...
Public Class rptLoyaltyCardMemberLedger4
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLoyaltyCardMemberLedger4.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RetailPOS.rptLoyaltyCardMemberLedger4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLoyaltyCardMemberLedger4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLoyaltyCardMemberLedger4 = New rptLoyaltyCardMemberLedger4()
        rpt.Site = Me.Site
        Return rpt
    End Function
