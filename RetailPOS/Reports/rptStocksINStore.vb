...
Public Class rptStocksINStore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RetailPOS.rptStocksINStore.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStocksINStore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStocksINStore = New rptStocksINStore()
        rpt.Site = Me.Site
        Return rpt
    End Function
