...
Public Class rptPurchasesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RetailPOS.rptPurchasesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchasesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchasesReport = New rptPurchasesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
